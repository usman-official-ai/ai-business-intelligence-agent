"""Professional AI Business Intelligence Dashboard - Dark Theme"""
...
st.markdown("""
    ...
    .stSuccess > div { color: #34d399 !important; }
    .stError {
        background: rgba(239, 68, 68, 0.08) !important;
        border: 1px solid rgba(239, 68, 68, 0.15) !important;
    }
    .stError > div { color: #f87171 !important; }
    .stInfo {
        background: rgba(56, 189, 248, 0.06) !important;
        border: 1px solid rgba(56, 189, 248, 0.1) !important;
    }
    .stInfo > div { color: #7dd3fc !important; }
                ...
                try:
                    ...
                    if response.status_code == 200:
                        ...
                        fig = px.bar(
                            ...
                            title='Top 3 Industry Predictions'
                        )
                        fig.update_layout(
                            height=300,
...
with tab2:
    ...
    with st.expander("📄 Download Sample Template"):
        sample = pd.DataFrame({
            'company_name': ['Tech Corp', 'Health Inc'],
            'description': ['AI company specializing in ML', 'Healthcare provider'],
            'website_exists': [1, 1],
            'contact_form': [1, 0],
            'services_count': [10, 5],
            'country_score': [3, 2]
